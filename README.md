...
**执行入口**：[升级执行工单](docs/ML_UPGRADE_WORK_ORDER_2026-09-04.md)已获授权，交给 Codex Astra 在隔离工作树实施；[升级前备份](docs/ML_PRE_UPGRADE_BACKUP_2026-09-04.md)已通过文件哈希、解压恢复及数据库完整性检查。当前运行目录尚未切换到升级版。
