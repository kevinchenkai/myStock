...
| 新一轮：开盘前决策＋隔夜／盘前信息（两市） | 港股 D1–D4 完成（[D1–D3](records/ml-overnight-d1d3_claude_20260906.md)、[D4](records/ml-overnight-d4_claude_20260906.md)）：腾讯、阿里过门槛；美股 D1／D3／D4 完成（[回执](records/ml-preopen-us-d4_claude_20260906.md)）：英伟达、特斯拉过门槛；小米、PDD 观察 | 进行中（Claude，main）：下一步为工程接入（V2 预测入口、决策时刻留档、ml.sh 按市场开盘前运行、Futu 盘前快照）与 D5 两市 shadow；生产不切换；四份回执待交 Codex Astra 审核 |
