...
def main():
    ...
    for window in (1, 2):
        for code in MAIN + OBS:
            ...
            for seed in seeds:
                for name, cols, params in (('B0_frozen', FEATURE_COLS_V1, {}), ('O2_overnight_small', V2, SMALL)):
    ...
    meta = dict(protocol=f'D4 pre-registered ({args.market}): O2 vs B0, seeds 0-4, W1 current 120 sessions, W2 previous 120; main gate on {MAIN} both sides >=5% and skill >=3% in both windows', market=args.market,
