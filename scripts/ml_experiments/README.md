...
- `overnight_d4`（2026-09-06）：预注册正式实验，`--db --out [--seeds]`，O2 对 B0、五种子、两窗口，小米另跑 KWEB 代理；结果见 [D4 回执](../../docs/records/ml-overnight-d4_claude_20260906.md)。`fetch_external --alt` 抓预注册的对照代理。
